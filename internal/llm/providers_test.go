...
func TestListProviders_Order(t *testing.T) {
	...
	expected := []string{"anthropic", "baidu-qianfan", "dashscope", "dashscope-tokenplan", "deepseek", "hy-tokenplan", "kimi", "longcat", "mimo", "minimax", "openai", "tencent-tokenhub", "volcengine", "z-ai"}
